...
<head>
    ...
    <!-- AdminLTE Skins -->
    {!! Html::style('templates/admin/css/skins/skin-green.min.css') !!}
...
<!-- AdminLTE App -->
{!! Html::script('templates/admin/js/adminlte.min.js') !!}

<!-- ChartJS -->
{!! Html::script('templates/admin/js/chart.js/Chart.js') !!}
<!-- FastClick -->
{!! Html::script('templates/admin/js/fastclick/lib/fastclick.js') !!}
<!-- AdminLTE for demo purposes -->
{!! Html::script('templates/admin/js/demo.js') !!}
<!-- page script -->
<script>
    $(function () {
        /* ChartJS
